...
Monarch Initiative | [Massive DB](http://massive.ucsd.edu) | hashed links like http://massive.ucsd.edu/ProteoSAFe/result.jsp?task=f847302a49e34ab89ebf3ecc2250be96&view=advanced_view, especially when surrounded by a lot of implementation-specific cruft, do not inspire confidence. They appear even as though they may be session-specific. Thus integrators like OmicsDI rightfully mint their own sensible ID for the entities like http://www.omicsdi.org/dataset/massive/MSV000078456 | persistence, documentation
Monarch Initiative | [Massive DB](http://massive.ucsd.edu) | There is a more persistent link to use with massive (relative to the one above); however, this is hard to find and also the local ID part is embedded in the middle of the URL, making it unusable in a typical CURIE expansion-collapse way. | Persistence, documentation
